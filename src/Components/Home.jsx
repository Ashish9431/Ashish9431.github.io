      ...
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
        ...
        <div style={{ color: "white" }}>
          ...
          >
            ...
            exceptional digital experiences. Currently, I’m focused onbuilding
            responsive full-stack web applications with useful Functionality
          </h5>
        </div>
        <br />
        ...
        <div>
          <Link to="work" smooth={true} duration={1400}>
            <button
              id="name"
              style={{ margin: "auto" }}
          ...
          <div id="cv">
            <a
              href="https://drive.google.com/file/d/1WIUk-7lkbkStXdxFkNx0tMvmQAGKXOCb/view?usp=share_link"
              target="_blank"
